...
export function GuestPage() {
  ...
  return <main className="guest-shell">
    ...
    <section className="guest-total"><ReceiptText/><div><span>{tab.data?.itemCount ?? 0} {t('items')}</span><strong>{formatMoney(tab.data?.totalCents ?? 0, language)}</strong></div></section>
