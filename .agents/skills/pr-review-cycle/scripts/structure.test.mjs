...
const PRODUCTION_STATE_IMPORTS = new Map([
  ...
  ['evidence/validation-plans.mjs', new Map([
    ...
    [stateModule('errors.mjs'), ['StateError']],
    [stateModule('git-authority.mjs'), ['assertValidationBaseAncestry', 'gitSnapshot']],
    [stateModule('journal.mjs'), ['appendEvent']],
...
const PRODUCTION_STATE_EXPORTS = new Map([
  ...
  ['git-authority.mjs', ['assertValidationBaseAncestry', 'inspectWorkerCommitAuthority', 'assertIntegratedWorkerCommit', 'gitSnapshot']],
