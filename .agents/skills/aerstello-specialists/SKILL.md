...
description: Select and apply Aerstello domain profiles, risk tags, and deterministic read-only reviewer routing. Use when planning, implementing, investigating, or reviewing work in apps/web, apps/api, packages/shared, financial or migration logic, executable behavior tests, or repository operations, including PR task specialization and exact-HEAD specialist evidence.
---
...
5. Apply [references/reviewer-contracts.md](references/reviewer-contracts.md) when requesting or checking read-only specialist evidence.
