...
export async function runCli(argv, {
  ...
  if (command === 'request' && !['discovery', 'verification', 'human-final'].includes(options.kind)) {
    throw new UsageError('request requires --kind discovery|verification|human-final');
  }
